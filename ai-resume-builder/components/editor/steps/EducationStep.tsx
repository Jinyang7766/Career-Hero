  ...
  <details className="group bg-white dark:bg-surface-dark rounded-xl shadow-md border border-slate-200 dark:border-[#324d67] overflow-hidden transition-all duration-300" open={wizardMode}>
    ...
    <div className="p-4 pt-0 border-t border-slate-200 dark:border-white/5 mt-2">
      {resumeData.educations.map((edu, index) => {
        ...
        return (
          <div key={edu.id} className="mt-4 flex flex-col gap-4 pb-6 border-b border-slate-200 dark:border-white/5 last:border-0 relative">
            ...
            <div className="grid gap-4">
              <div className="flex flex-col gap-2">
                <label className="text-xs font-bold text-slate-600 dark:text-text-secondary uppercase tracking-wider">学校名称 *</label>
                <input
                  className={`w-full rounded-lg bg-white dark:bg-[#111a22] border px-4 py-3 placeholder:text-slate-400 outline-none transition-all focus:ring-2 shadow-sm ${missingSchool
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold text-slate-600 dark:text-text-secondary uppercase tracking-wider">专业 *</label>
                  <input
                    className={`w-full rounded-lg bg-white dark:bg-[#111a22] border px-4 py-3 placeholder:text-slate-400 outline-none transition-all focus:ring-2 shadow-sm ${missingMajor
                        ? 'border-red-400 focus:ring-red-400/50 focus:border-red-400'
                        : 'border-slate-300 dark:border-[#324d67] focus:ring-primary/50 focus:border-primary'
                      } text-slate-900 dark:text-white`}
                    placeholder="专业"
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold text-slate-600 dark:text-text-secondary uppercase tracking-wider">学历 *</label>
                  <input
                    className={`w-full rounded-lg bg-white dark:bg-[#111a22] border px-4 py-3 placeholder:text-slate-400 outline-none transition-all focus:ring-2 shadow-sm ${missingDegree
                        ? 'border-red-400 focus:ring-red-400/50 focus:border-red-400'
                        : 'border-slate-300 dark:border-[#324d67] focus:ring-primary/50 focus:border-primary'
                      } text-slate-900 dark:text-white`}
                    placeholder="本科 / 硕士"
              ...
              <div className="flex flex-col gap-2">
                <label className="text-xs font-bold text-slate-600 dark:text-text-secondary uppercase tracking-wider">就读时间 *</label>
