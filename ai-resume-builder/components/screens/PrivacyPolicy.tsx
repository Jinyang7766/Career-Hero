            ...
            <main className="flex-1 overflow-y-auto p-5 space-y-6">
                ...
                <section className="space-y-4">
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-2xl p-5 shadow-sm border border-slate-100 dark:border-slate-700">
                        ...
                        <ul className="list-disc list-inside text-xs text-slate-600 dark:text-slate-400 space-y-1.5 ml-1">
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-2xl p-5 shadow-sm border border-slate-100 dark:border-slate-700">
                        ...
                        <ul className="list-disc list-inside text-xs text-slate-600 dark:text-slate-400 space-y-1.5 ml-1 font-medium">
                            <li>随时访问、修改或删除您的个人账号及简历信息；</li>
                            <li>注销账号（申请后您的所有个人数据将在 3 天内被永久擦除）；</li>
