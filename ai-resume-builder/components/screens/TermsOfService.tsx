        ...
        <div className="flex h-screen flex-col bg-background-light dark:bg-background-dark animate-in slide-in-from-right duration-300">
            <header className="sticky top-0 z-40 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md border-b border-slate-200 dark:border-white/5 shrink-0">
                <div className="flex items-center px-4 h-14 relative">
                    ...
                    <h2 className="absolute inset-0 flex items-center justify-center text-lg font-bold leading-tight tracking-[-0.015em] text-slate-900 dark:text-white pointer-events-none">服务条款</h2>
                </div>
            </header>
            ...
            <main className="flex-1 overflow-y-auto p-6 space-y-8 scroll-smooth no-scrollbar">
                ...
                <section className="space-y-6">
                    <div>
                        <h4 className="flex items-center gap-2 text-base font-black text-slate-900 dark:text-white mb-3">
                            <span className="inline-flex size-6 items-center justify-center rounded-full bg-primary/10 text-primary text-xs font-black">01</span>
                            账号注册与安全
                        </h4>
                        <p className="text-[13px] text-slate-600 dark:text-slate-400 leading-relaxed ml-8">
                    ...
                    <div>
                        <h4 className="flex items-center gap-2 text-base font-black text-slate-900 dark:text-white mb-3">
                            <span className="inline-flex size-6 items-center justify-center rounded-full bg-primary/10 text-primary text-xs font-black">02</span>
                            服务使用规则
                        </h4>
                        <p className="text-[13px] text-slate-600 dark:text-slate-400 leading-relaxed ml-8">
                    ...
                    <div>
                        <h4 className="flex items-center gap-2 text-base font-black text-slate-900 dark:text-white mb-3">
                            <span className="inline-flex size-6 items-center justify-center rounded-full bg-primary/10 text-primary text-xs font-black">03</span>
                            知识产权
                        </h4>
                        <p className="text-[13px] text-slate-600 dark:text-slate-400 leading-relaxed ml-8">
                    ...
                    <div>
                        <h4 className="flex items-center gap-2 text-base font-black text-slate-900 dark:text-white mb-3">
                            <span className="inline-flex size-6 items-center justify-center rounded-full bg-primary/10 text-primary text-xs font-black">04</span>
                            收费与退款
                        </h4>
                        <p className="text-[13px] text-slate-600 dark:text-slate-400 leading-relaxed ml-8">
                    ...
                    <div>
                        <h4 className="flex items-center gap-2 text-base font-black text-slate-900 dark:text-white mb-3">
                            <span className="inline-flex size-6 items-center justify-center rounded-full bg-primary/10 text-primary text-xs font-black">05</span>
                            服务变更或终止
                        </h4>
                        <p className="text-[13px] text-slate-600 dark:text-slate-400 leading-relaxed ml-8">
